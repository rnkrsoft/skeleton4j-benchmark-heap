 ...
 */
@Data
public class Add11AreaRequest implements Serializable {
    ...
    @ApidocElement(value = "区域类型2", valueDisplayType = ValueDisplayType.TREE, layout = WebLayout.LINEAR,
            interfaces = {
                    @WebCascadeInterface(
                            cascadeEvent = WebTriggerEvent.INIT,
                            serviceClass = CityService.class,
    ...
    @ApidocElement(value = "区域类型4", valueDisplayType = ValueDisplayType.TREE, layout = WebLayout.LINEAR,
            interfaces = {
                    @WebCascadeInterface(
                            cascadeEvent = WebTriggerEvent.INIT,
                            serviceClass = CityService.class,
    ...
    @ApidocElement(value = "区域类型5", valueDisplayType = ValueDisplayType.TREE, layout = WebLayout.LINEAR,
            interfaces = {
                    @WebCascadeInterface(
                            cascadeEvent = WebTriggerEvent.INIT,
                            serviceClass = CityService.class,
