 ...
 */
@WebPage(displayName = "一个单选树图字段（远程数据源）",
        priority = 8,
        author = "rnkrsoft.com",
        namespaces = {
                @WebNamespace(
                        hints = "一个单选树图字段（远程数据源）",
                        imports = {
                                @WebImport(gui = WebGui.MODEL, mode = WebMode.NORMAL, serviceClass = DialogBoxService.class, value = "getTree")
