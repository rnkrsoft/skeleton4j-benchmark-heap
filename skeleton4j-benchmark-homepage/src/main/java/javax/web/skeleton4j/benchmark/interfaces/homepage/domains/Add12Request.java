...
@Data
@ToString
public class Add12Request implements Serializable {
    @ApidocElement(value = "文件1", valueDisplayType = ValueDisplayType.FILE, required = false)
    String file1;

    @ApidocElement(value = "文件2", valueDisplayType = ValueDisplayType.FILE, required = true)
    String file2;
    ...
    @ApidocElement(value = "文件集3", valueDisplayType = ValueDisplayType.FILE, required = false, readonly = false, defaults = "/files/demo3.doc")
    final List<String> files3 = new ArrayList<String>();

    @ApidocElement(value = "文件集4", valueDisplayType = ValueDisplayType.FILE, required = true, readonly = false, defaults = "/files/demo4.doc")
    final List<String> files4 = new ArrayList<String>();

    @ApidocElement(value = "文件集5", valueDisplayType = ValueDisplayType.FILE, required = false, readonly = true, defaults = "/files/demo1.doc")
    ...
    @ApidocElement(value = "文件集8", valueDisplayType = ValueDisplayType.FILE, required = false, readonly = true, defaults = {"/images/demo1.jpg","/images/demo2.jpg"})
