 ...
 */
@Data
public class Group1Record implements Serializable{
    @ApidocElement(value = "余额", maxLen = 2, valueDisplayType = ValueDisplayType.DECIMAL, patternType = PatternType.FORMAT, pattern = "999999.99")
    String amt;

    @ApidocElement(value = "年龄1", maxLen = 2, valueDisplayType = ValueDisplayType.INTEGER)
    int age1;

    @ApidocElement(value = "年龄2", maxLen = 2, valueDisplayType = ValueDisplayType.INTEGER, defaults = "2")
    int age2;

    @ApidocElement(value = "年龄3", maxLen = 2, valueDisplayType = ValueDisplayType.INTEGER)
    Integer age3;

    @ApidocElement(value = "年龄4", maxLen = 2, valueDisplayType = ValueDisplayType.INTEGER, defaults = "4")
    Integer age4;

    @ApidocElement(value = "年龄5", maxLen = 2, valueDisplayType = ValueDisplayType.INTEGER)
    Integer age5;

    @ApidocElement(value = "年龄6", maxLen = 2, valueDisplayType = ValueDisplayType.INTEGER, defaults = "4")
    Integer age6;
