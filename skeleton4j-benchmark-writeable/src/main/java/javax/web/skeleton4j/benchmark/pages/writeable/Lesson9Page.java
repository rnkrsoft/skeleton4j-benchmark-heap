 ...
 */
@WebPage(displayName = "编辑对话框（下拉树图多选 远程数据源）",
        priority = 9,
        author = "rnkrsoft.com",
        namespaces = {
                @WebNamespace(
                        hints = "分页查询->编辑对话框（下拉树图多选 远程数据源）",
                        imports = {
                                @WebImport(gui = WebGui.FORM, mode = WebMode.QUERY, serviceClass = QueryService.class, value = "query9")
                        })
        }
)
