...
@NoArgsConstructor
@AllArgsConstructor
public class TableRecord2 implements Serializable{
    @ApidocElement(value = "流水号", valueDisplayType = ValueDisplayType.TEXT, maxLen = 36, placeholder = "演示文本")
    String serialNo;

    @ApidocElement(value = "年龄1", valueDisplayType = ValueDisplayType.INTEGER, maxLen = 2, placeholder = "演示数字", readonly = true)
    Integer age1;

    @ApidocElement(value = "年龄2", valueDisplayType = ValueDisplayType.INTEGER, maxLen = 1, placeholder = "演示一位数字", readonly = true)
    int age2;

    @ApidocElement(value = "金额1", valueDisplayType = ValueDisplayType.DECIMAL, maxLen = 3, placeholder = "演示一个浮点数", readonly = true)
    String amt1;


    @ApidocElement(value = "图片1", valueDisplayType = ValueDisplayType.IMAGE, maxLen = 255, placeholder = "演示图片显示", defaults = "/images/demo1.jpg", readonly = true)
    String image1;
    ...
    @ApidocElement(value = "多选1", placeholder = "请输入多选1", valueDisplayType = ValueDisplayType.SELECTION, enumClass = ProvinceEnum.class, defaults = "002", required = true, readonly = true)
    ...
    @ApidocElement(value = "树图单选1", placeholder = "请输入树图1", valueDisplayType = ValueDisplayType.TREE, interfaces = {
            @WebCascadeInterface(
                    ...
                    value = "fetchProvince",
//                    params = @WebParam(name = "xxxx", value = "1223"),
    ...
    },defaults = {"023", "0828"}, readonly = true)
    List<String> trees1;
    ...
    @ApidocElement(value = "日期2", valueDisplayType = ValueDisplayType.DATE, patternType = PatternType.FORMAT, pattern = "yyyy/MM/dd HH:mm:ss", placeholder = "演示日期yyyy/MM/dd HH:mm:ss", readonly = true)
    String date2;
}
